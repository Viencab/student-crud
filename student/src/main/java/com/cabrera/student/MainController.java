...
public class MainController {
    ...
    public @ResponseBody String addNewCar (
        ...
        try {
            ...
            response = "Success adding car with id: " + s.getId();
        } catch (Exception e) {
    ...
    @GetMapping
    public @ResponseBody Iterable<Student> getAllCars() {
        // This returns a JSON or XML with the users
        return studentRepository.findAll();
    }

    @GetMapping(path="/{id}") // Map ONLY POST Requests
    public @ResponseBody Optional<Student> getCar (@PathVariable Integer id) {
